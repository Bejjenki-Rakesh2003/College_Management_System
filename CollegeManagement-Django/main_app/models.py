...
class CustomUser(AbstractUser):
    ...
    hall_ticket_number = models.CharField(max_length=15, unique=False, blank=True, default=" ")  # Allow admin to enter
...
class Student(models.Model):
    ...
    hall_ticket_number = models.CharField(max_length=15, unique=True, blank=True, default=" ")  # Allow admin to enter
