# Generated by Django 4.2 on 2025-03-16 06:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hall_ticket_number', models.CharField(blank=True, default=' ', max_length=15, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hall_ticket_number', models.CharField(blank=True, default=' ', max_length=15)),
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main_app.course')),
